...
| Test Case            | TC-005                                                                                                                                                                                                       |
|:---------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Nome**             | Testare led fisici tramite modello fisico                                                                                                                                                                    |
| **Riferimento**      | REQ-0                                                                                                                                                                                                        |
| **Descrizione**      | Tramite modello virtuale si devono poter accendere singolarmente i vari led del modello fisico                                                                                                               |
| **Prerequisiti**     | Vedi TC-004                                                                                                                                                                                                  |
| **Procedura**        | 1. Eseguire il login come amministratore sul modello virtuale.<br>2. Cliccare le lettere che si vogliono accendere.<br>3. Controllare che sul modello fisico si siano accesi effetivamente i led selezionati |
| **Risultati attesi** | I led accesi sul modello fisico devono essere gli stessi che sono stati selezionati sul modello virtuale.                                                                                                    |
